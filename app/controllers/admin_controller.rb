class AdminController < ApplicationController
  ...
  def select_caller
    callers =  Archyves.last.nil? ? [] : Archyves.last.callers
  ...
  def select_payer
    payers =  Archyves.last.nil? ? [] : Archyves.last.payers
  ...
  def select_garbage_collector
    garbage_collectors =  Archyves.last.nil? ? [] : Archyves.last.gcs
